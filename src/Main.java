...
para el cálculo y finalmente presentar el resultado en pantalla. Ahora el programa ahora debe permitir al usuario
 realizar múltiples operaciones y almacenar los resultados en un arreglo.
 Además, debe manejar posibles errores de entrada del usuario. debes tener en cuenta que debes tener las mejores practicas de programación documentando el codigo apropiadamente colocando comentarios de cada accion del código con comentarios descriptivos que expliquen bien lo que se está haciendo en el código recuerda que java es un lenguaje orientado a objetos.
*/
